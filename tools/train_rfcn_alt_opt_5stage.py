...
def rpn_generate(queue=None, imdb_name=None, rpn_model_path=None, cfg=None,model_name = None,
    ...
    rpn_proposals_path = '/net/wujial/py-R-FCN/models/pascal_voc/ResNet-101/' + model_name + '/'+ rpn_net_name +imdb_name+ '_proposals.pkl'
...
if __name__ == '__main__':
    ...
    mp_kwargs = dict(
            ...
            rpn_model_path="/net/wujial/py-R-FCN/models/pascal_voc/ResNet-101/rfcn_alt_opt_5step_ohem/stage1_rpn_final.caffemodel",
            cfg=cfg,
            model_name =  args.model_name,
            rpn_test_prototxt=rpn_test_prototxt)
    ...
    #rpn_stage1_out['proposal_path'] = '/net/wujial/py-R-FCN/output/rfcn_alt_opt_5step_ohem/voc_0712_trainval/stage1_rpn_final.caffemodel'
    cfg.TRAIN.SNAPSHOT_INFIX = 'stage1'
    print solvers[1]
    mp_kwargs = dict(
            queue=mp_queue,
