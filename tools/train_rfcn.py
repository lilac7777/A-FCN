...
def get_solvers(imdb_name, net_name, model_name):
    ...
    if imdb_name.startswith('coco'):
        ...
        solvers = [[net_name, model_name, 'stage1_rfcn_ohem_solver80k120k.pt']]
...
def rpn_generate(queue=None, imdb_name=None, rpn_model_path=None, cfg=None,model_name = None,
    ...
    rpn_proposals_path = '/net/wujial/py-R-FCN/models/pascal_voc/ResNet-50/' + model_name + '/'+ rpn_net_name + '_proposals.pkl'
